  ...
  return (
    ...
    >
      ...
      w-full max-xl:padding-x pt-28">
        ...
        <p className="font-monteserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover stylish Nike arrivals, quality comfort and innovation for your active life.</p>
